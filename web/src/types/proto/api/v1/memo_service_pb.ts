...
export type MemoShare = Message<"memos.api.v1.MemoShare"> & {
   ...
   *
   * @generated from field: optional bool allow_download = 4;
   */
   ...
   * Unset on create means enabled.
   *
   * @generated from field: optional bool include_comments = 5;
   */
   ...
   *
   * @generated from field: optional google.protobuf.Timestamp last_view_time = 7;
   */
  lastViewTime?: Timestamp | undefined;
};
...
/**
 * @generated from message memos.api.v1.UpdateMemoShareRequest
 */
export type UpdateMemoShareRequest = Message<"memos.api.v1.UpdateMemoShareRequest"> & {
  /**
   * Required. The share to update, identified by its resource name.
   *
   * @generated from field: memos.api.v1.MemoShare memo_share = 1;
   */
  memoShare?: MemoShare | undefined;
...
/**
 * Describes the message memos.api.v1.UpdateMemoShareRequest.
 * Use `create(UpdateMemoShareRequestSchema)` to create a new message.
 */
export const UpdateMemoShareRequestSchema: GenMessage<UpdateMemoShareRequest> = /*@__PURE__*/
...
/**
 * @generated from message memos.api.v1.ListSharedMemoCommentsRequest
 */
export type ListSharedMemoCommentsRequest = Message<"memos.api.v1.ListSharedMemoCommentsRequest"> & {
  /**
   * Required. The opaque bearer token extracted from the share URL.
   *
   * @generated from field: string share_token = 1;
...
/**
 * Describes the message memos.api.v1.ListSharedMemoCommentsRequest.
 * Use `create(ListSharedMemoCommentsRequestSchema)` to create a new message.
 */
export const ListSharedMemoCommentsRequestSchema: GenMessage<ListSharedMemoCommentsRequest> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 30);

/**
 * @generated from message memos.api.v1.ListSharedMemoCommentsResponse
 */
export type ListSharedMemoCommentsResponse = Message<"memos.api.v1.ListSharedMemoCommentsResponse"> & {
  /**
...
/**
 * Describes the message memos.api.v1.ListSharedMemoCommentsResponse.
 * Use `create(ListSharedMemoCommentsResponseSchema)` to create a new message.
 */
export const ListSharedMemoCommentsResponseSchema: GenMessage<ListSharedMemoCommentsResponse> = /*@__PURE__*/
...
export const MemoService: GenService<{
   ...
   *
   * @generated from rpc memos.api.v1.MemoService.UpdateMemoShare
   */
  updateMemoShare: {
    methodKind: "unary";
    input: typeof UpdateMemoShareRequestSchema;
    output: typeof MemoShareSchema;
  },
  /**
   ...
   *
   * @generated from rpc memos.api.v1.MemoService.ListSharedMemoComments
   */
  listSharedMemoComments: {
    methodKind: "unary";
    input: typeof ListSharedMemoCommentsRequestSchema;
    output: typeof ListSharedMemoCommentsResponseSchema;
  },
  /**
