...
export type UserSetting_GeneralSetting = Message<"memos.api.v1.UserSetting.GeneralSetting"> & {
  ...
  /**
   * Telegram bot token used by the "send to Telegram" feature.
   *
  ...
  /**
   * Telegram chat id that memos are sent to.
   *
