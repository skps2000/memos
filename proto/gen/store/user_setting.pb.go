...
func (x *GeneralUserSetting) GetTelegramBotToken() string {
	if x != nil {
...
func (x *GeneralUserSetting) GetTelegramChatId() string {
	if x != nil {
...
const file_store_user_setting_proto_rawDesc = "" +
	...
	"\x12telegram_bot_token\x18\x05 \x01(\tR\x10telegramBotToken\x12(\n" +
	"\x10telegram_chat_id\x18\x06 \x01(\tR\x0etelegramChatId\"s\n" +
