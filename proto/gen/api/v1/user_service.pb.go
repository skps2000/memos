...
type UserSetting_GeneralSetting struct {
	...
	TelegramBotToken string `protobuf:"bytes,6,opt,name=telegram_bot_token,json=telegramBotToken,proto3" json:"telegram_bot_token,omitempty"`
...
func (x *UserSetting_GeneralSetting) GetTelegramBotToken() string {
	if x != nil {
...
func (x *UserSetting_GeneralSetting) GetTelegramChatId() string {
	if x != nil {
...
const file_api_v1_user_service_proto_rawDesc = "" +
	...
	"\x12telegram_bot_token\x18\x06 \x01(\tB\x03\xe0A\x01R\x10telegramBotToken\x12-\n" +
	"\x10telegram_chat_id\x18\a \x01(\tB\x03\xe0A\x01R\x0etelegramChatId\x1ay\n" +
	"\vTagMetadata\x12B\n" +
